...
const FormEditCategory = () => {
    ...
    return (
        <main className="main-formEditCategory">
            ...
            <p role="status" className="visually-hidden"> La Boite à Sel - Modifier une catégorie</p>
           ...
           <h2>Modifier une nouvelle catégorie</h2>
            <form onSubmit={submitForm}>
                ...
                <button className="button-yellow"> Modifiez la catégorie</button>
            </form>
