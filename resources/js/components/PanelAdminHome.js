    ...
    const Graph = () => {
        ...
        return (
            <div>
                ...
                <button className="button-blue" onClick={()=>{setDesc(desc === true ? false : true)}}> {desc === false ? "Connaitre les informations de changements de status" : "Fermer la description des changements de status"} </button>
                <InfosDesc/>
            </div>
        );
    }
